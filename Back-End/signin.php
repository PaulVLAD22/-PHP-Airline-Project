...
if ($token){
  ...
  && isset($_POST["confirmpass"]) && isset($_POST["emailInput"])){
    ...
    $confirmpass = htmlspecialchars($_POST['confirmpass'],ENT_QUOTES,'UTF-8');
    $email = htmlspecialchars($_POST["emailInput"],ENT_QUOTES,'UTF-8');
    $accountType = '';
  ...
  $_SESSION['signinFailed'] = true;
  $_SESSION['signinProblem']= 'CSRF Attack detected';
  header('location:../index.php');
}

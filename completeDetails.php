...
isset($_POST['socialStatus']) && isset($_POST['dateOfBirth']) && isset($_POST['nationality'])){
  ...
  $dbName = $configs['dbname'];
    ...
    $sql = "UPDATE passenger set identification_code='".$identification_code."',phone_number='".$phone_number."',first_name='".$first_name."',last_name='".$last_name."',date_of_birth='".$date_of_birth."',social_status='".$social_status."' where username='".$username."';";
